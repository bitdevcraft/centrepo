...
// Generic link section component
  ...
  <div>
    ...
    <ul className="space-y-4 text-sm text-muted-foreground">
      {links.map(({ label, href }) => (
        <li
          key={label}
          className="font-medium hover:text-primary hover:font-semibold"
        >
          <a href={href}>{label}</a>
        </li>
      ))}
  ...
  <div>
    ...
    <form className="grid gap-1.5">
      <div className="flex w-full items-center space-x-2">
        <Input type="email" data-slot="input" placeholder="Email" />
  ...
  return (
    <section className="py-32">
      <div className="container mx-auto px-4">
        <footer>
          <div className="grid grid-cols-4 gap-10 lg:grid-cols-6">
            {/* Logo & Description */}
          ...
          <div className="mt-20 flex flex-col justify-between gap-4 border-t pt-8 text-sm font-medium text-muted-foreground lg:flex-row lg:items-center">
            <p>
